...
public class MethodUtil {
    ...
    public static void main(String[] args) throws Exception {  
        // 匹配静态方法  
        String[] paramNames = getMethodParamNames(MethodUtil.class, "main", String[].class);  
        ...
        System.out.println(Arrays.toString(paramNames));  
        // 匹配特定签名的方法  
        paramNames = getMethodParamNames(MethodUtil.class, "getMethodParamNames", Class.class, String.class);  
        System.out.println(Arrays.toString(paramNames));  
    }  
